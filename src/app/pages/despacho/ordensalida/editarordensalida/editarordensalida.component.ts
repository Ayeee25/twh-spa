...
@Component({
  selector: 'app-editarordensalida',
  templateUrl: './editarordensalida.component.html',
  styleUrls: ['./editarordensalida.component.css']
})
export class EditarordensalidaComponent implements OnInit {
  es: any;
  date: Date = new Date();
